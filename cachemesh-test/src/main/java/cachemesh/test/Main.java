...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.out.println("usage: <say-hello> <profile>");
            return;
        }
         ...
         *
         * @Override public void onNodeJoin(String nodeUrl) throws Exception { System.out.println("join " + nodeUrl);
         * mesh.addRemoteNode(nodeUrl); }
         *
         * @Override public void onNodeLeave(String nodeUrl) throws Exception { System.out.println("leave " + nodeUrl);
         * // mesh.remoteNode(nodeUrl); } }); jgroups.start();
         */
